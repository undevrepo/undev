...
const string strMessageMagic = "undev Signed Message:\n";
...
// undev: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "undev", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "undev";
        CTransaction txNew;
        txNew.nTime = 1484057300;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484057300;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2011055 : 2011055;
        ...
        assert(block.hashMerkleRoot == uint256("0x2371cde241a9b19628f8439a203ce0d32454b6231ea2b6446f7f8bd10912993b"));
...
unsigned char pchMessageStart[4] = { 0x22, 0xc5, 0xb2, 0xd4 };
